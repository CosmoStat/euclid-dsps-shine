...
def amortized_config(config: dict[str, Any]) -> dict[str, Any]:
    ...
    raw["encoder"].setdefault(
        "set_n_bands", int(raw["features"].get("n_flux_bands", 10))
    )
    raw["encoder"].setdefault("set_token_dim", 64)
    ...
    raw["objective"]["wake"].setdefault("train_encoder", True)
    ...
    raw["objective"]["wake"].setdefault("proposal", {})
    raw["objective"]["wake"].setdefault("support_gate_enabled", False)
    raw["objective"]["wake"].setdefault(
        "min_object_ess_fraction_for_prior_update", 0.10
    )
    raw["objective"]["wake"].setdefault("max_object_weight_for_prior_update", 0.80)
    raw["objective"]["wake"].setdefault("warn_median_ess_fraction", 0.25)
    raw["objective"]["wake"].setdefault("fail_median_ess_fraction", 0.10)
    raw["objective"]["wake"].setdefault("fail_fraction_max_weight_above_0p8", 0.50)
    ...
    raw["objective"]["selection_correction"].setdefault("band", "lsst_r")
    raw["objective"]["selection_correction"].setdefault("max_mag_ab", 25.0)
    raw["objective"]["selection_correction"].setdefault("survey_noise", "gaussian_m5")
    ...
    raw["prior"].setdefault("core_dim", 5)
    raw["prior"].setdefault("core_layers", 10)
    raw["prior"].setdefault("conditional_layers", 10)
    ...
    raw["inference"].setdefault("posterior_base_temperature", 1.0)
