...
smoke_train_raw=$(sbatch --parsable --time=00:10:00 \
...
smoke_lens_raw=$(sbatch --parsable --time=00:10:00 \
...
smoke_finalize_raw=$(sbatch --parsable --time=00:10:00 \
...
submit_log="$LOG_DIR/submit_selfsup_production_${stamp}.log"
{
...
printf 'peak_training_gpus=12 peak_jlens_gpus=12\n'
